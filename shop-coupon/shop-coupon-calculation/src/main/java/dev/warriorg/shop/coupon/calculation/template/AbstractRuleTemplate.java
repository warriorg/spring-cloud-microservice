...
import dev.warriorg.shop.coupon.calculation.api.dto.Product;
...
public abstract class AbstractRuleTemplate implements RuleTemplate {
    ...
    public ShoppingCart calculate(ShoppingCart order) {
        ...
        // 获取以shopId为维度的价格统计
        Map<String, Long> sumAmount = this.getTotalPriceGroupByShop(order.getProducts());
        ...
        String shopId = template.getShopId();
    ...
    // key = shopId
    // value = 门店商品总价
    protected Map<String, Long> getTotalPriceGroupByShop(List<Product> products) {
        Map<String, Long> groups = products.stream()
